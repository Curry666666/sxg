          ...
          <div class="goodsDetail">
            ...
            <div class="support">
              ...
              <div class="supportArea">
                ...
                <div class="fixWidth">河南省 洛阳市 涧西区</div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    changeActive(spuSaleAttrValue, arr, index) {
      arr.forEach((item) => {
        item.isChecked = 0;
      });
      spuSaleAttrValue.isChecked = 1;
      this.skuSaleAttr[index].saleAttrValueName =
        spuSaleAttrValue.saleAttrValueName;
    },
    changeSkuNum(e) {
