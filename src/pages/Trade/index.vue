<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="way">
        ...
        <div class="info clearFix">
          ...
          <p>配送时间：预计7月16日（周六）09:00-15:00送达</p>
        </div>
      </div>
      <div class="detail">
        <h5>商品清单</h5>
    ...
    <div class="sub clearFix">
      ...
      <a v-if="userDefaultAddress.isDefault" class="subBtn" @click="submitOrder"
        >提交订单</a
      >
      <a v-else class="subBtn" @click="noCheck">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    userDefaultAddress() {
      // find方法 查找数组中符合要求的对象 返回第一个元素的值 筛选的一种
